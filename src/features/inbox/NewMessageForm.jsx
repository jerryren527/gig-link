    ...
    <>
      ...
      >
        ...
        <div className='new-message-form__input'>
          ...
          <input id="senderUsername-input" value={senderUsername} type='text' onChange={(e) => setSenderUsername(e.target.value)} required disabled />
        </div>

        <div className='new-message-form__input'>
          <label htmlFor='recipientUsername-input'>To: </label>
          <input id="recipientUsername-input" value={recipientUsername} type='text' onChange={(e) => setRecipientUsername(e.target.value)} required />
        </div>
